...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:CdShopConnection%>"
    SelectCommand="SELECT [Id], [ShippingRegion] FROM [ShippingRegion]" />
<asp:FormView ID="FormView1" runat="server" DataSourceID="ObjectDataSource1">
    <EditItemTemplate>
        <table class="UserDetailsTable">
            ...
            <tr>
                <td>Служебен телефонен номер: </td>
                <td>
            ...
            <tr>
                <td valign="top">Кредитна карта: </td>
                <td>
                    <table cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            <td width="140px">Име на картодържателя: </td>
                            <td width="200px">
            ...
            <tr>
                <td>
                    <asp:Button ID="UpdateButton" runat="server"
                        ...
                        Text="Запази" />&nbsp;
                    <asp:Button ID="UpdateCancelButton"
